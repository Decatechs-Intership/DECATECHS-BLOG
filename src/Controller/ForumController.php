...
class ForumController extends AbstractController
{
    ...
    #[Route('/{service_id}/{userPost}', name: 'show', requirements: ['service_id' => '\d+', 'userPost' => 'true|false'])]
    public function show(int $service_id, String $userPost, ServiceRepository $serviceRepository, PostRepository $postRepository): Response
    {
        ...
        if($userPost == 'true')
        {
            $posts = $postRepository->findPostsByUserAndServiceOrderedByDate($this->getUser(), $service_id);
        } else {
